...
const {CardElement} = require("@stripe/react-stripe-js");
...
const CheckoutForm = (props) => {
    ...
    function createOrder() {
        ...
        axios.post('http://simondu-ubuntu.uials.no:8080/api/createOrder', data).then(
    ...
    return paymentMethod ? (
            <div className="Result">
                ...
                <div className="ResultMessage">
                    Thanks for trying our Store. No money was charged
                </div>
                <Button onClick={reset}>Back to the store</Button>
            </div>
